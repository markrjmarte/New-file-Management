				...
				<div class="row" id="user-profile">
					...
					if(isset($_SESSION['login_id'])){
						...
						$users_query = $conn->query("SELECT users.profile_image, users_logs.* FROM users_logs 
							INNER JOIN users ON users_logs.users = users.username WHERE users.id = $user_id order by users_logs.id DESC;");
										...
										<div class="mb-5">
												<ul class="nav nav-tabs" id="myTab" role="tablist">
													...
													<li class="nav-item">
														...
														role="tab" aria-controls="activity" aria-selected="false"><i class="bx bxs-directions mr-1"></i></a>
													</li>
											...
											<div class="tab-content" id="myTabContent1">
												...
												<div class="tab-pane fade" id="activity" role="tabpanel" aria-labelledby="activity-tab">
													...
													<div class="table-data">
														<div class="order">
														<div class="card-body">
																<table id="productsTableLogs2" style="width:100%">
																	<h4 class = "table-title">My activity</h4>
																	<thead>
																		<tr>
																			<th scope="col">No.</th>
