...
$(document).ready(function () {
  ...
  if (productsTable.length != 0) {
    productsTable.DataTable({
      ...
      dom: '<"table-title">lfrtip',
    });
    $("div.table-title").html("");
  }

   /*======== 14. DATA TABLE ========*/
   var productsTabledashboard = $("#productsTabledashboard");
   if (productsTabledashboard.length != 0) {
    productsTabledashboard.DataTable({
       info: false,
       lengthChange: false,
       lengthMenu: [
         [10, 15, 20, -1],
   ...
   /*======== 15. DATA TABLE Shares ========*/
   var productsTableShares = $("#productsTableShares");
   if (productsTableShares.length != 0) {
    productsTableShares.DataTable({
       info: false,
       lengthChange: false,
       lengthMenu: [
         [10, 15, 20, -1],
  ...
  /*======== 16. DATA TABLE LOGS ========*/
  var productsTableLogs = $("#productsTableLogs");
  if (productsTableLogs.length != 0) {
    productsTableLogs.DataTable({
      info: false,
      lengthChange: false,
      lengthMenu: [
        [100, 200, 300, -1],
      ...
      columnDefs: [
        {
          orderable: false,
          targets: [ 2, 3], // Add the correct column numbers that shouldn't be sortable.
        },
      ],
      language: {
        search: "_INPUT_",
    ...
    $("div.table-title").html(""); // Set the table title here.
  }

  /*======== 16. DATA TABLE LOGS users ========*/
  var productsTableLogs2 = $("#productsTableLogs2");
  if (productsTableLogs2.length != 0) {
    productsTableLogs2.DataTable({
      info: false,
      lengthChange: false,
      lengthMenu: [
        [10, 15, 20, -1],
      ...
      columnDefs: [
        {
          orderable: false,
          targets: [1, 2, 3], // Add the correct column numbers that shouldn't be sortable.
        },
      ],
      language: {
        search: "_INPUT_",
    ...
    /*======== 16. DATA TABLE Announcement ========*/
    var productsTableAnnouncement = $("#productsTableAnnouncement");
    if (productsTableAnnouncement.length != 0) {
      productsTableAnnouncement.DataTable({
        info: false,
        lengthChange: false,
        lengthMenu: [
          [10, 15, 20, -1],
        ...
        columnDefs: [
          {
            orderable: false,
            targets: [1, 2, 3, 4], // Add the correct column numbers that shouldn't be sortable.
          },
        ],
        language: {
          search: "_INPUT_",
